...
public class CalendarHelperManager {
    ...
    public static let shared = CalendarHelperManager()
    ...
    private func createCalendar(commit: Bool = true, source: EKSource? = nil) -> NSError? {
        ...
        do {
            ...
            if source != nil {
                ...
                self.calendarName = self.eventStore.defaultCalendarForNewEvents?.title ?? "CustomCalendar"
                return error
            }
        }
    }
...
extension CalendarHelperManager {
